...
export function FloatingAddButton() {
  ...
  return (
    <button
      onClick={open}
      className="fixed bottom-6 right-6 w-14 h-14 bg-brand-600 text-white rounded-full shadow-lg hover:bg-brand-700 hover:shadow-xl transition-all flex items-center justify-center z-40 group"
