...
import type { Company, ClientType } from '@/lib/types'
...
export function CompanyActions({ company }: CompanyActionsProps) {
  ...
  const handleDelete = async () => {
    if (!confirm('Are you sure you want to delete this company? This will unlink associated contacts and deals.')) return
